      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="relative">
          ...
          <div className="flex items-center justify-center space-x-2 sm:space-x-3 mb-2">
            ...
            <h1 className="text-xl sm:text-3xl md:text-4xl font-bold text-foreground font-heading truncate px-2 bg-gradient-to-r from-foreground to-foreground/80 bg-clip-text text-transparent">
          ...
          {currentProject?.date && (
            <div className="space-y-1">
              <div className="text-sm sm:text-base md:text-lg text-muted-foreground font-medium px-2">
                <span className="block sm:inline">{format(new Date(currentProject.date), 'MMMM d, yyyy')}</span>
              </div>
              {daysUntilWedding > 0 && (
                <div className="text-xs sm:text-sm text-rose-500 dark:text-rose-400 font-semibold px-2">
