...
import { Heart, Home, Bot, Calendar, DollarSign, Users, Store, Palette, User, Clock, Globe, Sparkles, Armchair, UserPlus, Activity, FileText } from "lucide-react";
...
const navigation = [
  ...
  { name: "Seating Chart", href: "/seating-chart", icon: Armchair },
  { name: "Vendors", href: "/vendors", icon: Store },
  { name: "Schedules", href: "/schedules", icon: Clock },
  { name: "Inspiration", href: "/inspiration", icon: Palette },
  { name: "Creative Details", href: "/creative-details", icon: Sparkles },
...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white shadow-lg border-r border-gray-100 hidden lg:flex lg:flex-col z-30 overflow-hidden">
